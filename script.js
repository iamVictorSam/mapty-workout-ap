...
// const cycling1 = new Cycling([39, -19], 27, 95, 528);
...
class App {
  ...
  _newWorkout(e) {
    ...
    const distance = +inputDistance.value; // adding a + symbol convert the string to number
    ...
    // hide from + clearing input field
